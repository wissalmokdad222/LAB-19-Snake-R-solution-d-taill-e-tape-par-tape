...
.method public static A(Landroid/view/View;Landroid/view/KeyEvent;)Z
    ...
    invoke-static {p0}, LY0/c;->g(Ljava/lang/Object;)V
...
.method public static B(LJ/k;Landroid/view/View;Landroid/view/Window$Callback;Landroid/view/KeyEvent;)Z
    .locals 6
    ...
    sput-object v1, LB/h;->b:Ljava/lang/reflect/Method;
    :try_end_0
    .catch Ljava/lang/NoSuchMethodException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    sput-boolean v3, LB/h;->a:Z

    :cond_2
    sget-object v1, LB/h;->b:Ljava/lang/reflect/Method;
    ...
    sput-object p0, LB/h;->d:Ljava/lang/reflect/Field;
    ...
    :catch_2
    sput-boolean v3, LB/h;->c:Z

    :cond_a
    sget-object p0, LB/h;->d:Ljava/lang/reflect/Field;
...
.method public static final J(LU0/a;)Ljava/lang/Class;
    .locals 2
...
.method public static Q(Landroid/widget/TextView;)LH/e;
    .locals 7
    ...
    invoke-static {p0}, LP/p;->c(Landroid/widget/TextView;)Landroid/text/PrecomputedText$Params;

    move-result-object p0

    invoke-direct {v0, p0}, LH/e;-><init>(Landroid/text/PrecomputedText$Params;)V
    ...
    invoke-static {p0}, LP/n;->a(Landroid/widget/TextView;)I

    move-result v3

    invoke-static {p0}, LP/n;->d(Landroid/widget/TextView;)I
    ...
    invoke-static {p0}, LP/o;->a(Ljava/util/Locale;)Landroid/icu/text/DecimalFormatSymbols;

    move-result-object p0

    invoke-static {p0}, LP/p;->b(Landroid/icu/text/DecimalFormatSymbols;)[Ljava/lang/String;
    ...
    invoke-direct {v0, v2, p0, v3, v4}, LH/e;-><init>(Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;II)V
...
.method public static U(Landroid/widget/EditText;)Z
    .locals 0
...
.method public static a0(Landroid/content/Context;Landroid/net/Uri;)Ljava/nio/MappedByteBuffer;
    .locals 8
...
.method public static e(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1, p2}, LB/h;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z

    move-result v0

    invoke-static {p0, p1, p3}, LB/h;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_5
    invoke-static {p0, p1, p2}, LB/h;->Y(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
...
.method public static i0(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;)V
    .locals 5
...
.method public static final j0(Landroid/view/View;Landroidx/activity/B;)V
    .locals 1
...
.method public static o0(Landroid/widget/TextView;I)V
    ...
    invoke-static {p0, p1}, LP/p;->d(Landroid/widget/TextView;I)V
...
.method public static r(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :try_start_1
    invoke-static {p0, p1}, LB/h;->s(Ljava/io/File;Ljava/io/InputStream;)Z

    move-result p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-static {p1}, LB/h;->o(Ljava/io/Closeable;)V
...
.method public static s(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    :cond_0
    invoke-static {v3}, LB/h;->o(Ljava/io/Closeable;)V
    ...
    invoke-static {v2}, LB/h;->o(Ljava/io/Closeable;)V
...
.method public static s0(Landroid/view/View;LC0/g;)V
    .locals 3

    iget-object v0, p1, LC0/g;->a:LC0/f;
    ...
    :cond_0
    iget-object p0, p1, LC0/g;->a:LC0/f;

    iget v1, p0, LC0/f;->m:F
    ...
    invoke-virtual {p1}, LC0/g;->n()V

    :cond_1
    return-void
.end method

.method public static t(Landroid/content/Context;)Landroidx/emoji2/text/s;
    .locals 8
    ...
    invoke-static {v1, v2}, LB/h;->k(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v4}, LC0/e;->f(Landroid/content/pm/PackageManager;Ljava/lang/String;)[Landroid/content/pm/Signature;
    ...
    invoke-direct {v0, p0, v1}, Landroidx/emoji2/text/r;-><init>(Landroid/content/Context;LG/e;)V
...
.method public static t0(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
    .locals 2
...
.method public static u0(Landroid/graphics/drawable/Drawable;I)V
    .locals 0
...
.method public static y(Ljava/lang/String;)[LB/g;
    .locals 17
    ...
    :cond_c
    invoke-static {v6, v11}, LB/h;->q([FI)[F
...
.method public static z([LB/g;)[LB/g;
    .locals 4
...
.method public static z0(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)Landroid/view/ActionMode$Callback;
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, LP/r;-><init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
...
.method public C(I[LG/k;)LG/k;
    ...
    invoke-virtual {v0, v8}, LC0/e;->g(Ljava/lang/Object;)I
    ...
    invoke-virtual {v0, v8}, LC0/e;->i(Ljava/lang/Object;)Z
...
.method public abstract D(LC0/u;FF)V
.end method
...
.method public abstract b0(Ljava/lang/Throwable;)V
.end method
...
.method public abstract c0(Landroidx/emoji2/text/v;)V
.end method
...
.method public abstract v(Landroid/content/Context;LA/g;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
.end method

.method public abstract v0(Landroid/view/View;F)Z
.end method

.method public abstract w(Landroid/content/Context;[LG/k;I)Landroid/graphics/Typeface;
.end method
...
.method public x(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2, p3}, LB/h;->r(Ljava/io/File;Landroid/content/res/Resources;I)Z
...
.method public abstract y0(Landroid/view/ViewGroup$MarginLayoutParams;II)V
.end method
